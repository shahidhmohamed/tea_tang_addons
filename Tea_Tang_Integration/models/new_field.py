...
class PosOrderNew(models.Model):
    ...
    receipt_uniq = fields.Char(required=True, copy=False, readonly=True, default=lambda self: _('New'))
...
class PosOrderNext(models.Model):
    ...
    receipt_uniq_2 = fields.Char(required=True, copy=False, readonly=True, default=lambda self: _('New'))
