...
patch(Order.prototype, {
    setup(_defaultObj, options) {
        ...
        this.seq_number = this.seq_number || "";
    ...
    export_as_JSON() {
        ...
        json.seq_number = this.seq_number;  // Include the card number in the exported JSON
        return json;
    },
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            if (env.services.pos.config.use_custom_receipt) {
                ...
                const new_seq_number = order.seq_number
                console.log("New Seq", new_seq_number)
...
patch(PaymentScreen.prototype, {
    ...
    async _finalizeValidation() {
        ...
        if (seqNumber !== null && this.currentOrder) {
            this.currentOrder.set_new_seq_number(seqNumber);
            console.log("Current Order with seq Number:", this.currentOrder);
        }

        await super._finalizeValidation();  // Ensure to call the super method after handling the current order
    }
});
